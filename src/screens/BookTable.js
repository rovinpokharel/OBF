...
const BookTable = () => {
  ...
  const [slots, setSlots] = useState([
    { sloT: "10:00AM", selected: false },
    { sloT: "12:00PM", selected: false },
    { sloT: "02:00PM", selected: false },
    { sloT: "04:00PM", selected: false },
    { sloT: "06:00PM", selected: false },
    { sloT: "08:00PM", selected: false },
  ]);
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.container}>
        <Header icon={require("../../images/back.png")} title={"Book Table"} />
        <Image
          source={require("../../images/table.png")}
          style={styles.docImg}
        />
        <Text style={styles.name}>Table 1</Text>
        <Text style={styles.spcl}>Seats: 6</Text>
        ...
        <View style={styles.btnView}>
          <CommonBtn
            ...
            // navigation.navigate('Success', { screen: 'BookTable' });
            }}
          />
        </View>
      </View>
